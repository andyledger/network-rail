<?php do_action( 'amp_menu'); ?>

<header id="top" class="tw-p-4">
	<div class="tw-flex tw-justify-center tw-relative">
		<a 
			href="<?php echo esc_url( $this->get( 'home_url' ) ); ?>" 
			aria-label="Network Rail logo linking home page" 
			class="tw-block"
		>
			<span class="tw-text-12xl tw-text-primary">
				<svg style="fill: currentColor" width="1em" height="0.4em" class="" aria-label="lg_nr_gradient icon" role="img" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 200 652 250"> 
...
<div class="tw-bg-gradient-to-r tw-from-primary tw-to-brand-orange-light" style="height: 2px;"></div>