...
<?php $__env->startSection('content'); ?>
  ...
  <section class="sm:tw-flex tw-justify-between tw-mb-8">
    ...
    <div class="tw-flex tw-items-center">
      <a href="<?php echo e(get_permalink( get_option( 'page_for_posts' ) )); ?>" class="tw-cursor-pointer tw-border tw-border-gray-light tw-p-3 tw-text-sm tw-text-gray-dark tw-rounded tw-inline-flex tw-items-center tw-justify-between tw-underline hover:tw-text-hyperlinks">
        <span class="tw-mr-8">
          More stories
        </span>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/jerometoole/code/wholegrain-projects/network-rail/wp-content/themes/network-rail/resources/views/front-page.blade.php ENDPATH**/ ?>