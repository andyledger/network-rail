        ...
        >
          ...
          >
            <a
              ...
              :aria-current="state.currentRefinement === page ? 'page' : null"
            >{{ page + 1 }}</a>
          </slot>
        </li>
...
import { createPanelConsumerMixin } from '../../../node_modules/vue-instantsearch/src/mixins/panel';
import { createWidgetMixin } from '../../../node_modules/vue-instantsearch/src/mixins/widget';
import { createSuitMixin } from '../../../node_modules/vue-instantsearch/src/mixins/suit';
